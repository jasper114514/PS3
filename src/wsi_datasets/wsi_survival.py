...
from src.utils.pandas_helper_funcs import df_sdir, series_diff
...
class WSIOmicsSurvivalDataset(WSISurvivalDataset):
    ...
    def __init__(self,
        ...
        #df_gene['case_id'] = df_gene['case_id'].str[:-3]
        ...
        elif self.omics_modality == 'no_proto_omics':
            print('no_proto_omics')
        else:
    ...
    def _setup_func_genes(self, signature_path='/home/u2092920/dev/MMP-main/src/data_csvs/rna/metadata'):
        r"""
    ...
    def _setup_pathways(self, type_of_path='hallmark', signature_path='/home/u2092920/dev/MMP-main/src/data_csvs/rna/metadata'):
        r"""
    ...
    def __getitem__(self, idx):
        ...
        if self.omics_modality == 'functional':
            for oidx in range(6):
                omics_list.append(torch.tensor(self.omics_data.loc[case_id, self.omic_names[oidx]]))
...
class WSIOmicsTextSurvivalDataset(WSIOmicsSurvivalDataset):
    """
    WSI Survival Dataset, combined with omics data.
    This is the main dataset for MMP project
    """
    def __init__(self,
        ...
        super().__init__(df_histo, df_gene,data_source,target_transform,sample_col,slide_col,survival_time_col,censorship_col,
                         n_label_bins,label_bins, bag_size,include_surv_t0,prepare_emb,omics_dir,omics_modality,type_of_path)
    ...
    def __getitem__(self, idx):
        ...
        case_path = f'{self.reports_dir}/{case_id}.pt'
        text_embeds = torch.load(case_path)

        out['text'] = text_embeds
        out['case_id'] = case_id
