import os
from src.mil_models import (PANTHER, OT, H2T, ProtoCount)

from src.mil_models import (PANTHERConfig, OTConfig, ProtoCountConfig, H2TConfig)
...
def create_embedding_model(args, mode='classification', config_dir='/home/u2092920/dev/MMP-main/src/configs'):
    """
...
def create_multimodal_survival_model(args, omic_sizes=[]):
    ...
    if args.model_mm_type in ['coattn_text', 'text', 'gene', 'histo']:
        model = coattn_text(omic_sizes=omic_sizes,
        ...
        model = DAttention_Text(n_classes = 4, dropout=0.25, act="relu",n_features=512)
