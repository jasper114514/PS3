...
# model / loss fn args ###
parser.add_argument('--n_proto', type=int, help='Number of prototypes', default=16)
...
# dataset / split args ###
parser.add_argument('--data_source', type=str, default='/media/u2092920/Data/TCGA/HNSC/PLIP_features/feats_pt',
                    help='manually specify the data source')
parser.add_argument('--results_dir', type=str, default='/media/u2092920/Data/MMP/Images/Attention_Viz/BLCA',
                    help='manually specify the results_dir')
parser.add_argument('--split_dir', type=str, default='/media/u2092920/Data/MMP_2/MMP_Splits_2/tcga-hnsc/TCGA_HNSC_overall_survival_k=4',
